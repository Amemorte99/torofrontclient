...
@Component({
  selector: 'app-bas-page-form',
  templateUrl: './bas-page-form.component.html',
  styleUrls: ['./bas-page-form.component.css']
})
export class BasPageFormComponent implements OnInit {
