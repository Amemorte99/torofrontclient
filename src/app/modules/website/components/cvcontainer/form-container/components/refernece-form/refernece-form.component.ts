...
@Component({
  selector: 'app-refernece-form',
  templateUrl: './refernece-form.component.html',
  styleUrls: ['./refernece-form.component.css']
})
export class ReferneceFormComponent implements OnInit {
